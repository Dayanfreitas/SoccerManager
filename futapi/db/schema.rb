...
ActiveRecord::Schema.define(version: 2022_04_10_225606) do
  ...
  create_table "games", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["enterprise_id"], name: "index_games_on_enterprise_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["access_type_id"], name: "index_users_on_access_type_id"
  ...
  add_foreign_key "games", "enterprises"
  ...
  add_foreign_key "users", "access_types"
end
